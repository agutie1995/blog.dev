...
@section('content')
	    ...
	    <div class="box-block">
	     	<div class="time-line">
                ...
                <div class="event-content">
                  <h4>Fellow</h4>
                  <h5 class="location">Codeup</h5>
                  <h5>Oct 2015 - Current</h5>
                  <ul>
                    <li class="resume-li">Assist students in understanding course material</li>
                    <li class="resume-li">Oversee study hall and assist students in course work</li>
                  <ul>
                </div>
            </div>
            <div class="item-event">
  ...
  <!-- ========= Start Languages progress bars section =================================-->
    <h3 class="title with-icon"><span class="fa fa-code icn-title"></span> Languages</h3>
    <div class="box-block">
